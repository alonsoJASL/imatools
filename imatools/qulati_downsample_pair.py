...
iou.cout("Downsampling {} from {} to {} points".format(outLargeName, largeN, smallN), print2console=verbose)
largePts, largeEl = vtku.extractPointsAndElemsFromVtk(largeMsh)
if largeMsh.GetPointData().GetScalars() is None :
    iou.cout('Attempting to pass cell data to point data in {}'.format(outLargeName), print2console=verbose)
