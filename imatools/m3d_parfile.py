...
if __name__ == '__main__':
    ...
    paramters_group.add_argument('--verbose', '-verbose', type=bool)
    paramters_group.add_argument('--eval_thickness', '-eval_thickness', type=bool, metavar='1/0')
    ...
    paramters_group.add_argument('--out_medit', '-out_medit', type=bool, metavar='1/0')
    paramters_group.add_argument('--out_vtk', '-out_vtk', type=bool, metavar='1/0')
    paramters_group.add_argument('--out_carp', '-out_carp', type=bool, metavar='1/0')
    paramters_group.add_argument('--out_vtk_binary', '-out_vtk_binary', type=bool, metavar='1/0')
    paramters_group.add_argument('--out_carp_binary', '-out_carp_binary', type=bool, metavar='1/0')
    paramters_group.add_argument('--out_potential', '-out_potential', type=bool, metavar='1/0')
