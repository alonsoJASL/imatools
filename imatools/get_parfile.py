...
if __name__ == '__main__':
    ...
    iparse.add_argument('--seg_name', '-seg_name', type=str)
    ...
    iparse.add_argument('--outdir', '-outdir', type=str, help='Subdirectory of outputs in parfile')
    iparse.add_argument('--name', '-name', type=str, help='Name of the output file')
