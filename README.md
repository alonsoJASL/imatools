...
alternatively, use the `setup.sh`, which creates a file you can do `source IMATOOLS_ENV_SETUP` on, which sets the `PYTHONPATH` and activates the `imatools` conda environment.
